...
class SpidersTestCase(unittest.TestCase):
    ...
    def test_add_tbody(self):
        # result = add_tbody('body > table:nth-child(3) > tr:nth-child(1) > td:nth-child(2) > table:nth-child(4) > tr:nth-child(2) > .px12c > table > tr > td > div > founder-content *::text')
        result = add_tbody('body > table:nth-child(3) > tr:nth-child(1) > td:nth-child(1) > table > tr > td > table:nth-child(2) > tr > td:nth-child(1) > div *::text, body > table:nth-child(3) > tbody > tr:nth-child(1) > td:nth-child(1) > table > tr > td > table:nth-child(2) > tr > td:nth-child(1) > div *::text, body > table:nth-child(3) > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr > td > table:nth-child(2) > tr > td:nth-child(1) > div *::text, body > table:nth-child(3) > tbody > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr > td > table:nth-child(2) > tr > td:nth-child(1) > div *::text, body > table:nth-child(3) > tr:nth-child(1) > td:nth-child(1) > table > tr > td > table:nth-child(2) > tbody > tr > td:nth-child(1) > div *::text, body > table:nth-child(3) > tbody > tr:nth-child(1) > td:nth-child(1) > table > tr > td > table:nth-child(2) > tbody > tr > td:nth-child(1) > div *::text, body > table:nth-child(3) > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr > td > table:nth-child(2) > tbody > tr > td:nth-child(1) > div *::text, body > table:nth-child(3) > tbody > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr > td > table:nth-child(2) > tbody > tr > td:nth-child(1) > div *::text')
        print(result)